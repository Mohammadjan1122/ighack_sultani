...
██║░╚═╝░██║╚█████╔╝██║░░██║██║░░██║██║░╚═╝░██║██║░╚═╝░██║██████╔╝
╚═╝░░░░░╚═╝░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░░░░╚═╝╚═════╝░
              telegram chanel   t.me/sultani1122     creator    mohammad sultani
...
' |lolcat
printf "\n"
printf "                \e[101m\e[1;77m  >>  Script By mohammad sultani << \e[0m\n"
printf "\n"
printf "  \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m youtube  mohammad hacker \e[100m\e[1;77m << \e[0m\n"
printf "\n"
echo 
...
cd $HOME/ighack_sultani_sultani/main
bash auto.sh
elif [[ $option == 2 || $option == 02 ]]; then
cd $HOME/ighack_sultani_sultani/main
bash manual.sh
elif [[ $option == 3 || $option == 03 ]]; then
cd $HOME/ighack_sultani_sultani/core
bash about.sh
elif [[ $option == 4 || $option == 04 ]]; then                                                                                                                
cd $HOME/ighack_sultani/core
bash update.sh
elif [[ $option == 5 ]]; then
exit 1
